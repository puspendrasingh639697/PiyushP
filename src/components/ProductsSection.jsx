...
//           viewport={{ once: true }}
//         >
//           <span className="inline-block bg-green-400 text-white mb-4 px-4 py-2  text-sm font-semibold">
//             Our Products
//           </span>
...
export default function ProductsSection() {
  ...
  return (
    <section id="products" className="py-24 bg-black/90">
      <div className="container mx-auto px-6">
        {/* Header */}
        <motion.div
          className="text-center mb-16"
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl lg:text-5xl font-bold mb-4 text-green-500">
            Our Products
          </h2>
          <p className="text-xl italic text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Handpicked. Hygienic. Honest.
          </p>
          <p className="text-base italic text-gray-400 mt-3 max-w-3xl mx-auto">
            NayaVayapar offers carefully sorted, quality-tested Makhana — straight from Bihar's ponds to your shelves
          </p>
        </motion.div>
